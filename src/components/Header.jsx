...
const Header = () => {
  return (
    <div className="flex flex-col md:flex-row flex-wrap rounded-lg px-6 md:px-10 lg:px"
  style={{ backgroundColor: 'rgb(118, 180, 255)' }}>
      {/*----left side---*/}
      ...
      <div className='md:w-1/2 relative'>
        <img className='w-full md:absolute bottom-0 h-auto rounded-lg' src={assets.header2_img} alt="" />
      </div>
    </div>
  );
};
